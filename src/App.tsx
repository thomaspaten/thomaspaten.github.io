      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex gap-4 mt-6 justify-center">
              {projectImages.map((img: ProjectImage, idx: number) => (
                <button
                  ...
                  className={`relative w-24 h-20 rounded-lg overflow-hidden transition-all ${activeImage === idx
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                  ...
                  <a
                    href="mailto:thomaspaten01@gmail.com"
          ...
          <div className="flex gap-4 justify-center">
            <a
              href="https://github.com/thomaspaten/chicken-incubator-arduino"
            ...
            <a
              href="https://github.com/thomaspaten/chicken-incubator-arduino/blob/main/README.md"
          ...
          <footer className="text-center text-xs text-gray-400 mt-16">
            <p>© 2025 Thomas Patenenaude Poulin • AI-assisted development • Built with ❤️ and modern tools</p>
          </footer>
        </div>
      </div>
    </div>
